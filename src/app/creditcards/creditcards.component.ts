...
const TABLE_DATA: CreditCard[] = [
  {
    ...
    "termsAndConditions": "Trick to Rob."
  },
  {
    "id": 2,
  ...
  },
  {
    ...
    "interestRate": 9,
    "introOffer": 200,
    "recommendedCreditScore": "400-500",
...
export class CreditcardsComponent {
  displayColumns = ["select", "id", "cardName", "bankName", "maxCredit", "interestRate"];
